...
with st.sidebar:
    ...
    chunk_size = st.number_input("Chunk Size", min_value=64, max_value=4096, value=1024, step=64, key="ni_chunk_size")
    overlap = st.number_input("Overlap", min_value=0, max_value=500, value=100, step=10, key="ni_overlap")
